...
# an equilateral triangle: see equilateral_triangle.py
# a square: see square.py
# a pentagon: see pentagon.py
# a hexagon: see hexagon.py
# an octagon: see octagon.py
# a star: see star.py
# a circle: see circle.py
